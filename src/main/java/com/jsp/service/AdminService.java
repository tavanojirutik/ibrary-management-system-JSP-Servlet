...
public class AdminService {
	...
	public boolean updateadmin(int id, String pass) {
		return adminDao.updateadmin(id, pass);
	}
	
	public boolean loginAdmin(String user,String pass) {
		List<Admin> admins = adminDao.getAllres();
		for (Admin admin: admins) {
			if (user!=null && user.equals(admin.getAdmin_email()) && pass != null && pass.equals(admin.getAdmin_pass())) {
				return true;
				}
		}
		return false;
